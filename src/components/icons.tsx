...
export const CornerOrnament = ({
	...
	>
		...
		<path
			d="M8 2 Q12 4 12 8 Q14 6 16 8 M2 8 Q4 12 8 12 Q6 14 8 16"
			stroke={color}
			strokeWidth="0.7"
			fill="none"
		/>
...
export const Fleuron = ({
	...
	<svg aria-hidden="true" width={size * 3} height={size} viewBox="0 0 72 24">
		...
		/>
		<path
			d="M36 4 Q32 8 28 12 Q32 16 36 20 Q40 16 44 12 Q40 8 36 4 Z"
			fill="none"
			stroke={color}
			strokeWidth="0.8"
		/>
...
export const FramedPanel = ({
	...
	<div
		className={`framed-panel ${className}`}
...
export const Icon = {
	...
	Scroll: ({ s = 16 }: IconProps) => (
		...
		>
			...
			/>
			<path
				d="M19 5 V 17 A 2 2 0 0 0 21 19 H 7"
				stroke="currentColor"
				strokeWidth="1.3"
			/>
		</svg>
	...
	D20: ({ s = 16 }: IconProps) => (
		...
		>
			...
			/>
			<path
				d="M3 8 L 12 14 L 21 8 M 12 14 V 22 M 12 2 V 14"
				stroke="currentColor"
				strokeWidth="0.8"
			/>
		</svg>
	...
	Sound: ({ s = 16, muted = false }: IconProps & { muted?: boolean }) => (
		...
		>
			...
			{!muted && (
				<path
					d="M16 9 Q 18 12 16 15 M 18 6 Q 22 12 18 18"
					stroke="currentColor"
					strokeWidth="1.3"
				/>
			)}
			{muted && (
				<path
					d="M16 9 L 21 14 M 21 9 L 16 14"
					stroke="currentColor"
					strokeWidth="1.3"
				/>
			)}
